        ...
        <div className="bg-card/90 backdrop-blur-sm border border-border rounded-lg overflow-hidden mb-16">
          ...
          <div className="p-8 text-center">
            ...
            <p className="text-lg text-muted-foreground max-w-xl mx-auto mb-10">
              There’s no such thing as the perfect training split. Train in a
              way that fits you. There are 120 of ways to build a 5-day split —
              what matters is what works for your body, your schedule, and your
              goals. Don’t get caught up in how others train. You have one body,
              one mind — make it yours.
            </p>

            <p className="text-2xl text-muted-foreground max-w-xl mx-auto mb-10">
            ...
            >
              ...
              <div className="flex items-center justify-between px-4 py-2 border-b border-border bg-background/70">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm text-primary">USER.{plans.id}</span>
                </div>
                <div className="text-sm text-muted-foreground">
                  {plans.fitness_level.toUpperCase()}
                </div>
              </div>
              ...
              <CardHeader className="pt-6 px-5">
                <div className="flex items-center gap-4 mb-4">
                  <div className="h-16 w-16 rounded-full overflow-hidden border border-border">
                    <img
                      src={plans.profilePic}
                      alt={`${plans.first_name}`}
                  ...
                  <div>
                    ...
                    <div className="text-sm text-muted-foreground flex items-center gap-2 mt-1">
                      ...
                      {plans.age}y • {plans.workout_days}d/week
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="px-5">
                    ...
                    <div className="flex-1">
                      <div className="flex justify-between items-center">
                        <h3 className="font-medium text-foreground">
                          {plans.workout_plan.title}
                        </h3>
                      </div>
                      <p className="text-sm text-muted-foreground mt-1">
                        {plans.equipment_access}
                      </p>
                    </div>
                  </div>
                ...
                <div className="mt-5 pt-5 border-t border-border">
                  <div className="text-sm text-muted-foreground">
                    ...
                    {plans.workout_plan.description.substring(0, 120)}...
                  </div>
                </div>
              </CardContent>
            </Card>
